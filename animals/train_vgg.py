...
# Vgg16, epochs=20, lr=0.001, best_acc=  0.9235816542948039
'''
...
results_file = "./results/results_VGG16.txt"
...
# 保存最优权重地址
save_path = './best_weights/VGG16.pth'
best_acc = 0.0
loss_train = []
loss_test = []
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('./train_test_loss_for_VGG16.png')