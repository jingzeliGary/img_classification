...
# MobileNet V2, epochs=20, lr=0.001, best_acc= 0.7073060268646165
'''
import os
import numpy as np
import torch
...
results_file = "./results/results_MobileNet_V2.txt"
...
# 保存最优权重地址
save_path = './best_weights/MobileNet_V2.pth'
best_acc = 0.0
loss_train = []
loss_test = []
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('./train_test_loss_for_MobileNet_V2.png')