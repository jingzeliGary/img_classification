...
class MetricLogger(object):
    '''
    主要用来打印输出训练的时候产生的一些数据
    '''
    def __init__(self, delimiter="\t"):
        self.meters = defaultdict(SmoothedValue)  #记录的内容, defaultdict(SmoothedValue)就是创建了一个默认值为SmoothedValue类型的字典
        self.delimiter = delimiter # 显示打印输出的格式化符号
    ...
    def log_every(self, iterable, print_freq, header=None):
        ...
        :param print_freq: 每过几张图片,打印一次当前结果
        :param header:
        :return:
        '''
        i = 0
