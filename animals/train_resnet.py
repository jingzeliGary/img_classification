...
# ResNet34, epochs=20, lr=0.001, best_acc= 0.9465469247083775
'''
import os
import numpy as np
import torch
...
# 加载模型
model = resnet34()
model.load_state_dict(torch.load('./weights/resnet34-b627a593.pth'))
...
results_file = "./results/results_ResNet34.txt"
...
# 保存最优权重地址
save_path = './best_weights/ResNet34.pth'
best_acc = 0.0
loss_train = []
loss_test = []
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('./train_test_loss_for_ResNet34.png')
