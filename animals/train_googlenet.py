...
# GoogleNet, epochs=20, lr=0.001, best_acc=  0.7905068045245671
'''
import os
import numpy as np
import torch
...
results_file = "./results/results_GoogleNet.txt"
...
# 保存最优权重地址
save_path = './best_weights/GoogLeNet.pth'
best_acc = 0.0
loss_train = []
loss_test = []
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('./train_test_loss_for_GoogLeNet.png')